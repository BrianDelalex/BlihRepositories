...
namespace nts
{
    ...
    Comp4001::Comp4001(const std::string &value) : _name(value), _type("4001")
    {
    }
    ...
    Tristate Comp4001::compute(std::size_t pin)
    {
        if (pin == 3)
        {
            ...
            this->o1.pin = (Tristate) (not (this->a1.pin || this->b1.pin));
            return (this->o1.pin);
        }
        if (pin == 4)
        {
            ...
            this->o2.pin = (Tristate) (not (this->a2.pin || this->b2.pin));
            return (this->o2.pin);
        }
        if (pin == 10)
        {
            ...
            this->o3.pin = (Tristate) (not (this->a3.pin || this->b3.pin));
            return (this->o3.pin);
        }
        if (pin == 11)
        {
            ...
            this->o4.pin = (Tristate) (not (this->a4.pin || this->b4.pin));
            return (this->o4.pin);
        }

    }

    void Comp4001::setPin(std::size_t pin, Tristate value)
    {

    }

    void Comp4001::setLink(std::size_t pin, std::unique_ptr<nts::IComponent> *other, std::size_t otherPin)
    {
    ...
    std::string Comp4001::getType() const { return (this->_type); }

    std::string Comp4001::getName() const { return (this->_name); }

    Tristate Comp4001::getPin(std::size_t pin) const
    {
        switch (pin)
        {
        case 1:
